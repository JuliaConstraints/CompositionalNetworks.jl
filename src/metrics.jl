...
function hamming(icn::AbstractICN, configurations::Configurations, solution_vector; parameters...)
    sum(
        x -> abs(evaluate(icn, x; parameters...) - hamming(x.x, solution_vector)), configurations
    )
end
...
function manhattan(icn::AbstractICN, configurations::Configurations, solution_vector; parameters...)
    sum(
        x -> abs(evaluate(icn, x; parameters...) - manhattan(x.x, solution_vector)), configurations
